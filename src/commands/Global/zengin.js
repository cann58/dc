...
module.exports = {
  ...
  execute: async (client, message, args, embed, author, channel, guild) => {
    ...
    if (!name) return channel.error(message, `Öncelikle bir kullanıcı adı giriniz!`)
    if (name.length > 32) return channel.error(message, `Lütfen **32** karakteri geçmeyen bir isim belirtiniz!`)
