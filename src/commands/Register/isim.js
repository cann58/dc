...
module.exports = {
    ...
    execute: async (client, message, args, embed, author, channel, guild) => {
        ...
        channel.send(embed.setDescription(`${member} kullanıcısının ismi başarıyla " \`${config.registration.Symbol} ${name} ${config.registration.symbol} ${age}\` " olarak değiştirildi!`));
    }
}