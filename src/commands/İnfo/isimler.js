...
module.exports = {
    ...
    execute: async (client, message, args, embed, author, channel, guild) => {
        ...
        if (!names) return channel.error(message, "Bu kullanıcının isim geçmişi bulunmuyor!").catch(err => console.log(err), client.ytick(message)).then(m => m.delete({timeout: 10000}));
