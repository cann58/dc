...
module.exports = {
    ...
    execute: async (client, message, args, embed, author, channel, guild) => {
        ...
        channel.send(embed.setDescription(`${member} kullancısına başarıyla <@&${config.roles.team}> rolü verildi!`)).catch(err => console.log(err), client.ytick(message)).then(m => m.delete({timeout: 10000}));
    }
}