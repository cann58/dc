...
module.exports = {
    ...
    execute: async (client, message, args, embed, author, channel, guild) => {
        ...
        channel.send(embed.setDescription(`${member} **(${member.id})** kişisi **"${reason}"** sebebiyle ${author} tarafından ilk uyarısını aldı, bir daha uyarı almamaya dikkat et! (Ceza Numarası: \`#${db.fetch(`ceza_${guild.id}`)}\`)`))
